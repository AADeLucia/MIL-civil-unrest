...
def main():
    ...
    train_dataset = MILTwitterDataset.from_glob(exp_args.train_files, positive_bags, tokenizer,
                                                samples_per_file=exp_args.num_tweets_per_day,
                                                shuffle_samples=exp_args.shuffle_samples,
                                                random_seed=train_args.seed)
    eval_dataset = MILTwitterDataset.from_glob(exp_args.valid_files, positive_bags, tokenizer,
                                               samples_per_file=exp_args.num_tweets_per_day,
                                               shuffle_samples=False, random_seed=train_args.seed)
    test_dataset = MILTwitterDataset.from_glob(exp_args.test_files, positive_bags, tokenizer,
                                               samples_per_file=exp_args.num_tweets_per_day,
                                               shuffle_samples=False, random_seed=train_args.seed)
